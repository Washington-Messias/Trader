 ...
 * @author Windows 7
 */
public class SalvarArquivos extends javax.swing.JFrame {

    /**
     * Creates new form SalvarArquivos
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalvarArquivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalvarArquivos().setVisible(true);
            }
        });
    }
